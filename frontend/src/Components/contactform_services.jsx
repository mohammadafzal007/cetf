...
const contactform_services = ({setopenform}) => {
    const {
        register,
        handleSubmit,
        reset,
 ...
 <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-[1001]'>
          ...
          <div className=" flex mt-10 justify-items-start flex-col m-2 p-2 bg-blue-500 rounded-3xl w-[350px] 
            md:w-[390px] md:h-[520px]  z-">
              ...
              className="mb-2 self-end px-2 py-1 text-white rounded-full"
            >
             <i class="fa-solid fa-xmark"></i>
            </button>
              <motion.h1
                
                className="text-3xl font-semibold text-white pt-2 text-center">Contact For Services</motion.h1>
             {/* <motion.h1
...
export default contactform_services